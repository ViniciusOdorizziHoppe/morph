# ============================================
# SCRIPT DE MIGRAÇÃO MORPH - POWERSHELL
# ============================================

# Definir diretório base (ajuste se necessário)
$baseDir = "C:\Users\Vinícius\OneDrive\Documentos\sistemasistema\morph\backend"
...
# ============================================
# ARQUIVO: package.json (ATUALIZADO SEM HELMET)
# ============================================
$packageJson = @'
{
  "name": "morph-api",
...
'@
Set-Content -Path (Join-Path $baseDir "config\cloudinary.js") -Value $cloudinaryConfig -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "config\database.js") -Value $databaseConfig -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "config\replicate.js") -Value $replicateConfig -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "utils\promptBuilder.js") -Value $promptBuilder -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "utils\logger.js") -Value $logger -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "utils\validators.js") -Value $validators -Encoding UTF8

Write-Host "✓ Utils criados" -ForegroundColor Green
...
'@
Set-Content -Path (Join-Path $baseDir "middleware\upload.js") -Value $uploadMiddleware -Encoding UTF8
...
module.exports = { auth };
'@
Set-Content -Path (Join-Path $baseDir "middleware\auth.js") -Value $authMiddleware -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "middleware\errorHandler.js") -Value $errorHandler -Encoding UTF8

Write-Host "✓ Middleware criado" -ForegroundColor Green
...
'@
Set-Content -Path (Join-Path $baseDir "models\User.js") -Value $userModel -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "models\Generation.js") -Value $generationModel -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "models\CreditTransaction.js") -Value $transactionModel -Encoding UTF8

Write-Host "✓ Models criados" -ForegroundColor Green
...
'@
Set-Content -Path (Join-Path $baseDir "services\cloudinaryService.js") -Value $cloudinaryService -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "services\imageGenerationService.js") -Value $imageGenerationService -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "services\creditService.js") -Value $creditService -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "services\queueService.js") -Value $queueService -Encoding UTF8

Write-Host "✓ Services criados" -ForegroundColor Green

# ============================================
# JOBS
# ============================================

# jobs/imageGenerationJob.js
$imageJob = @'
...
'@
Set-Content -Path (Join-Path $baseDir "jobs\imageGenerationJob.js") -Value $imageJob -Encoding UTF8

Write-Host "✓ Jobs criados" -ForegroundColor Green
...
'@
Set-Content -Path (Join-Path $baseDir "controllers\imageController.js") -Value $imageController -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "controllers\creditController.js") -Value $creditController -Encoding UTF8

Write-Host "✓ Controllers criados" -ForegroundColor Green
...
'@
Set-Content -Path (Join-Path $baseDir "routes\imageRoutes.js") -Value $imageRoutes -Encoding UTF8
...
module.exports = router;
'@
Set-Content -Path (Join-Path $baseDir "routes\creditRoutes.js") -Value $creditRoutes -Encoding UTF8

Write-Host "✓ Routes criadas" -ForegroundColor Green

# ============================================
# APP E SERVER (SEM HELMET - CORRIGIDO)
# ============================================
...
module.exports = app;
'@
Set-Content -Path (Join-Path $baseDir "app.js") -Value $appJs -Encoding UTF8
...
'@
Set-Content -Path (Join-Path $baseDir "server.js") -Value $serverJs -Encoding UTF8

Write-Host "✓ App e Server criados" -ForegroundColor Green
...
Write-Host "3. Teste a API (veja exemplos abaixo)" -ForegroundColor White
'

# Salvar script
$scriptPath = "C:\Users\Vinícius\OneDrive\Documentos\sistemasistema\morph\criar-estrutura.ps1"
Set-Content -Path $scriptPath -Value $scriptCompleto -Encoding UTF8

Write-Host "Script salvo em: $scriptPath" -ForegroundColor Green
Write-Host "Execute-o com: .\criar-estrutura.ps1" -ForegroundColor Yellow